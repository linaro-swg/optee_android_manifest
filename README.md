...
To build AOSP:
```bash
make TARGET_BUILD_KERNEL=true TARGET_BUILD_UEFI=true CFG_SECURE_DATA_PATH=n #TARGET_BOOTIMAGE_USE_FAT=true
```

For a 4GB board, use:
```bash
make TARGET_USERDATAIMAGE_4GB=true TARGET_BUILD_KERNEL=true TARGET_BUILD_UEFI=true CFG_SECURE_DATA_PATH=n #TARGET_BOOTIMAGE_USE_FAT=true
```
